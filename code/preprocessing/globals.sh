...
scanner_dir=/jukebox/dicom/conquest/Skyra-AWP45031/GraziL/2023 #Sample project data

# 2. Edit where your project directory is
project_dir=/jukebox/graziano/coolCatIsaac/MEI

# 3. Edit where your scratch and work directories are located (note: make sure you have setup a work directory on scratch)
scratch_dir=/jukebox/graziano/coolCatIsaac/MEI/data/work
