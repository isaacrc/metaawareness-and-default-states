...
run1="\""ses-02/func/sub-${subj}_ses-01_task-None_run-01_bold.nii.gz"\","
run2="\""ses-02/func/sub-${subj}_ses-01_task-None_run-02_bold.nii.gz"\","
run3="\""ses-02/func/sub-${subj}_ses-01_task-None_run-03_bold.nii.gz"\","
run4="\""ses-02/func/sub-${subj}_ses-01_task-None_run-04_bold.nii.gz"\","
run5="\""ses-02/func/sub-${subj}_ses-01_task-None_run-05_bold.nii.gz"\","
end="],"

insert="${beginning}${run1} ${run2} ${run3} ${run4} ${run5} ${run6}${end}"

# # insert IntendedFor field after line 35 (i.e., it becomes the new line 36)
sed -i "31 a \ \ ${insert}" $bids_dir/sub-$subj/ses-02/fmap/sub-${subj}_ses-02_dir-AP_epi.json
sed -i "31 a \ \ ${insert}" $bids_dir/sub-$subj/ses-02/fmap/sub-${subj}_ses-02_dir-PA_epi.json
