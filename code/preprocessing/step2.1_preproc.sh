...
run1="\""ses-01/func/sub-${subj}_ses-01_task-None_run-01_bold.nii.gz"\","
run2="\""ses-01/func/sub-${subj}_ses-01_task-None_run-02_bold.nii.gz"\","
run3="\""ses-01/func/sub-${subj}_ses-01_task-None_run-03_bold.nii.gz"\","
run4="\""ses-01/func/sub-${subj}_ses-01_task-None_run-04_bold.nii.gz"\","
run5="\""ses-01/func/sub-${subj}_ses-01_task-None_run-05_bold.nii.gz"\","
run6="\""ses-01/func/sub-${subj}_ses-01_task-None_run-06_bold.nii.gz"\","
end="],"

insert="${beginning}${run1} ${run2} ${run3} ${run4} ${run5} ${run6}${end}"

# # DELETE IntendedFor field after line 35 (i.e., it becomes the new line 36)
#sed -i "/IntendedFor/d" $bids_dir/sub-$subj/ses-01/fmap/sub-${subj}_ses-01_dir-AP_epi.json
#sed -i "/IntendedFor/d" $bids_dir/sub-$subj/ses-01/fmap/sub-${subj}_ses-01_dir-PA_epi.json

# # DELETE IntendedFor field after line 35 (i.e., it becomes the new line 36)
sed -i "/scout/d" $bids_dir/sub-$subj/ses-01/sub-${subj}_ses-01_scans.tsv
#sed -i "/IntendedFor/d" $bids_dir/sub-$subj/ses-01/fmap/sub-${subj}_ses-01_dir-PA_epi.json

# # DELETE IntendedFor field after line 35 (i.e., it becomes the new line 36)
#sed -i "/_ses-01_task/d" $bids_dir/sub-$subj/ses-01/fmap/sub-${subj}_ses-01_dir-AP_epi.json
#sed -i "/_ses-01_task/d" $bids_dir/sub-$subj/ses-01/fmap/sub-${subj}_ses-01_dir-PA_epi.json
